...
const s_stylePath = '/assets/css/comment-widget-pink.css';
const s_formId = '1FAIpQLSdmcO4fUZpzQogx7unDqrPuDEOlBqZ-Zke3qFbK1e0_bnUkdA';
const s_nameId = '1681127387';
const s_websiteId = '873192703';
const s_textId = '1615646286';
const s_pageId = '904897350';
const s_replyId = '1241885266';
const s_sheetId = '1M_0k8idSnV-EnCrzGZIZAmKpyJipr1vWjLeWunAvTcE';
const s_moderatedId = '1541700824'; // The Moderated field ID
...
function createComment(data) {
    ...
    if(data.Moderated == false) {
        name.innerText = 'unknown friend'; // Change 'Guest' to whatever you want
    }
    ...
    if(data.Moderated == false) {
        text.innerText = 'waiting for moderation...'; // Change this value to whatever you want
    }
