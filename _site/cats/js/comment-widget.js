/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="/cats/js/comment-widget.js"></script>
...
const s_stylePath = '/cats/css/comment-widget-pink.css';
const s_formId = '1FAIpQLSdPMv16ybhWAYoiY2SSiBxmFYIUUnbW7oQn_jIqJWipeWKRAA';
const s_nameId = '738140064';
const s_websiteId = '116296036';
const s_textId = '155100063';
const s_moderatedId = '1635929568'; // The Moderated field ID
const s_adminId = '110017618'; // Admin field ID
const s_pageId = '849845949';
const s_replyId = '1818983748';
const s_sheetId = '14P8Vfw3O1qm64xL93s0NK4rkbuUBmTYhcQcZLRpvyow';
...
const s_websiteFieldLabel = 'Website <em>(optional)</em>';
const s_textFieldLabel = '';
const s_submitButtonLabel = 'Submit';
const s_loadingText = 'fetching comments ...';
...
function createComment(data) {
    ...
    if(data.Admin == true) {
    name.insertAdjacentHTML('beforeend', " <img src='/cats/img/favicon.gif' style='width:16px; height:16px; margin-bottom: -4px;' title='admin' alt='admin'> ");
    } 
